...
function SignUp({onAuthentication}) {
  ...
  return (
    <div className="mask d-flex align-items-center h-100 "
     style={{ backgroundImage: 'url("https://img.freepik.com/premium-photo/big-double-cheddar-cheeseburger-with-chicken-cutlet_147620-1306.jpg?size=626&ext=jpg&ga=GA1.2.831985192.1688442252&semt=sph")',
  ...
  {/**/}          <label className="form-label" htmlFor="form3Example4cg">Password</label>
                  ...
                  <div className='d-flex justify-content-center'>
                    <button className='btn btn-success' type="button" onClick={handleSubmit}>Sign Up</button>
                  </div>
                  ...
                  <p className="text-center text-muted mt-5 mb-0">Have an account already ? <Link to='/signin'
